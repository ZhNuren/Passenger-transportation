...
$sql = "SELECT orders.Order_ID, orders.User, orders.Seats*travelplace.Seat_Price from orders, travelplace where orders.Place_ID=travelplace.Travel_ID";
...
<?php 
$query="select sum(Seats*Seat_Price) as Total from orders, travelplace";
...
foreach($dats as $rol){
echo "<p align='right'><b> Income from trip: ";
echo $rol['Total'];
echo " KZT</b></p>";
}
?>
